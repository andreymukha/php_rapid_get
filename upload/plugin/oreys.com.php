...
<?
			$page = geturl("www.oreys.com", 80, "/", "", 0, 0, 0, "");
?>
...
<?
			...
			$post["name-desc"]=$descript;
			
			$url=parse_url($action_url);
			$upfiles=upfile($url["host"],$url["port"] ? $url["port"] : 80, $url["path"].($url["query"] ? "?".$url["query"] : ""),"http://www.oreys.com", 0, $post, $lfile, $lname, "myfile");
