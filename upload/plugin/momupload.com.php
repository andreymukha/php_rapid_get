...
<?php
			$page = geturl("momupload.com", 80, "/", "", 0, 0, 0, "");
...
<?php
			...
			$upfiles=upfile($url["host"],defport($url), $url["path"].($url["query"] ? "?".$url["query"] : ""),"http://momupload.com/", 0, $post, $lfile, $lname, "file1x");
...
<?php		
            ...
            $page = geturl("momupload.com", 80, "/upload_result.php", "http://momupload.com", 0, $post, 0, ""); 
            is_page($page);
            ...
            $tmp= cut_str($page,'remfile.php','style');
